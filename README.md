...
| 对应章节 | 主要内容 |
|----------|----------|
| **第一章** | 初识大模型：语言模型发展历程、大模型技术基础、GPT和DeepSeek模型介绍 |
| **第二章** | 模型架构：Transformer模型介绍、模型详细配置、长上下文模型和新型架构 |
| **第三章** | 预训练：预训练之数据工程、预训练之具体流程、训练优化、模型参数量与训练效率估计 |
| **第四章** | 指令微调：指令微调与常见策略、轻量化微调 |
| **第五章** | 人类对齐：人类对齐之基础、人类对齐之进阶 |
| **第六章** | 解码与部署：大模型解码、解码效率分析与加速算法、模型压缩 |
| **第七章** | 提示学习：提示设计、上下文学习、思维链提示、检索增强生成 |
...
### 申请流程
1. **发送邮件至**：`batmanflyatruc.edu.cn`
2. **邮件标题**：`《大语言模型》PPT课件- {姓名}- {机构}`
3. **邮件内容**：
